<?php
/*
	PHP ConfigurationsTest
	author: David Kempf
*/
class System_Configurations_ConfigurationsTest extends PHPUnit_Framework_TestCase
{
	...
	function testConfigurations()
	{
    	...
    	$this->assertTrue(0 == count($missedConfigurations), '[ERROR] Es existieren keine Script-Eintraege fuer die folgenden Configurations:'.PHP_EOL.implode(PHP_EOL, $missedConfigurations));
	}
